...
//	}
	...
	@Override
	public List<Trainee> getAllTrainees() {
		TypedQuery<Trainee> query = entityManger.createNamedQuery("Trainee.getAllTrainees", Trainee.class);
		List<Trainee> trainees = query.getResultList();		
		return trainees;
	}
	
	@Override
	public List<Trainee> getAllTraineesByDomain() {
		TypedQuery<Trainee> query = entityManger.createNamedQuery("Trainee.getAllTraineeByDomain", Trainee.class);
